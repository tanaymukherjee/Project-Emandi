...
public class Farmerprofile {
	...
	private String name,emailid,renewpassword,newpassword,oldpassword,gender,dob,mobno,llno,address,state,city,pincode,newsletter,usertype,registrationno="null";
	 private Connection con;
	   ...
	   public Farmerprofile()
	   {
	    ...
	    public Farmerprofile(String emailid) {
		...
		public Farmerprofile(String emailid,String name,String mobno,String llno,
		...
		public Farmerprofile(String llno, String address, String state, String city,
			String pincode) {
		...
		public Farmerprofile(String renewpassword,String newpassword, String oldpassword) {
		...
		public ResultSet getfarmerprofile() throws Exception
	    {
	        con=Mycon.getConnection();
		...
		public boolean updatefarmerprofile() throws Exception
	    {
	        con=Mycon.getConnection();
