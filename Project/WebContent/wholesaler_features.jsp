...
<tr>
                    <form action="wholesalerrequirementcontact.jsp" method="post" name="inbox">
...
<tr>
                    <form action="wholesaleravailabilitycontact.jsp" method="post" name="inbox">
   ...
   <%}%>        
       ...
       <div class="tab">
          ...
          <div align="center" style="background-color:#E0E0E0">
          <p>&nbsp;</p>
             <form name="post_requirement" method="post" action="wholesalerrequirement.jsp" style="width: 516px; height: 319px">
...
<div class="tab">
          ...
          <div align="center" style="background-color:#E0E0E0">
          <p>&nbsp;</p>
             <form name="post_availability" method="post" action="wholesalerpostavailability.jsp" style="width: 516px; height: 319px">
  ...
  <tr>
     ...
     <td></td>
      ...
      <div class="tab">
          ...
          <div align="center" style="background-color:#E0E0E0">
          <p>&nbsp;</p>
             <form name="feedback" method="post" action="wholesalercomplaint.jsp" style="width: 516px; height: 319px">
