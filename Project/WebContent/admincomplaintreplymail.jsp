...
<div id="container">
  ...
  c11.setComplaintid(cid);
  c11.setName(name);
  c11.setUser(user);
  c11.setSubject(subject);
  %>
    ...
    <li>Send Mail</li>
      ...
      <div class="tab-content">
        <div class="tab show">
          ...
          <p></p> 
          <form name="reply_admin" method="post" action="adminreplymailcomplaint.jsp" style="width: 516px; height: 319px">
  ...
  <tr>
    <td><input type="hidden" name="cid" value="<%=c11.getComplaintid()%>" size="0px"> </td>
  </tr>  
  <tr>
    <td><input type="hidden" name="name" value="<%=c11.getName()%>" size="0px"> </td>
  </tr>
  <tr>
    <td><input type="hidden" name="user" value="<%=c11.getUser()%>" size="0px"> </td>
  </tr>
  <tr>
    <td><input type="hidden" name="subject" value="<%=c11.getSubject()%>" size="0px"> </td>
  </tr>
</table>
