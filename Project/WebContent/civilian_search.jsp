...
<div id="container">
        ...
        <div id="menu-wrapper">
          <div id="smoothmenu1" class="ddsmoothmenu">
            <ul>
              ...
              <li><a href="civilian_search.jsp" class="selected">Search</a></li>
  ...
  <div id="wrapper">
   ...
   <!-- whose profile indicator-->
     <div id="portfolio">
      ...
      <ul id="tab-menu">
    <li class="selected">Search Mandies</li>    
      ...
      <div class="tab-content">
        ...
        <div align="center" style="background-color:#E0E0E0">
          <p>&nbsp;</p>
             <form name="post_requirement" method="post" action="civilian_search1.jsp" style="width: 516px; height: 319px">
             
          <table border="1" cellpadding="1" cellspacing="1" class="auto-style1" style="width: 460px; height: 321px">
  <tr>
    <td height="48">Select Product:</td>
    <td><select name="select_product1" id="commodity1" onChange="setType1();" size="1" style="width: 95px; height: 25px;">
       <option value="vegetable">Vegetable</option>
       <option value="cereal">Cereal</option>
       <option value="fruit">Fruit</option>
    </select> <select name="select_product" id="type1" size="1" style="width: 97px; height: 25px;">
  ...
  <tr>
     <td colspan="2" align="center"> <input name="post" class="button gray" type="submit" value="Search" style="width: 100px"/></td>
