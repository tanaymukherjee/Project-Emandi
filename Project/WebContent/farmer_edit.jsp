...
function OnSubmitForm()
{
  ...
  {
   document.myform.action ="farmerupdateavailability.jsp";
  }
  else
  if(document.pressed == 'Delete')
  {
    document.myform.action ="farmerdeleteavailability.jsp";
  }
  return true;
}
</script>
   ...
   <!-- whose profile indicator-->
    ...
    <li>Update Availability</li>
      ...
      <div class="tab-content">
        ...
        <p>&nbsp;</p>
        <form name="form1" method="post" action="farmerchangepassword.jsp" style="width: 516px; height: 319px">
...
%>
        <div class="tab">
          ...
          <div align="center" style="background-color:#E0E0E0">
          <p></p> 
          <form name="form1" action="updatefarmerprofile.jsp" method="post" style="width: 516px; height: 319px">
      
      <table width="471" height="283" border="1" align="center" cellpadding="1" cellspacing="1" style="height: 282px; width: 555px">
      <tr>
      	<td><b>Farmer id</b>&nbsp;&nbsp;&nbsp;&nbsp;<b></td>
      	<td><INPUT type=text name="farmerid" readonly="readonly" VALUE="<%=a1.getEmailid()%>"></td>
      </tr>
      <tr><td><b>Farmer Name</b>&nbsp;&nbsp;&nbsp;&nbsp;<b></td>
...
<form action="farmerupdateavailability.jsp" method="post" name="myform" onsubmit="return onsubmitform();">
   <tr>
