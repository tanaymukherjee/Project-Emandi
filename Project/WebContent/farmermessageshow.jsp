      ...
      <div id="header">
        ...
        <div id="menu-wrapper">
          <div id="smoothmenu1" class="ddsmoothmenu">
            <ul>
              <li><a href="farmer_home.jsp" class="selected">Home</a></li>
...
%> 
  ...
  <div id="wrapper">
    ...
    <form action="deletefarmermessage.jsp" method="post">
     <table border="1">
   ...
   <td colspan="2" align="left"><a href="farmer_mail.jsp"><font color="red">Back To Inbox &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp </font></a></td>
