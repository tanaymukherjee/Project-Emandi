	...
	private String name,emailid,renewpassword,newpassword,oldpassword,gender,dob,mobno,llno,address,state,city,pincode,newsletter,usertype,registrationno="null";
	 private Connection con;
	   ...
	   public Civilian()
	   {
	    ...
	    public Civilian(String emailid) {
		...
		public Civilian(String emailid,String name,String mobno,String llno,
		...
		public Civilian(String llno, String address, String state, String city,
			String pincode) {
		...
		public Civilian(String renewpassword,String newpassword, String oldpassword) {
		...
		public ResultSet getcivilian() throws Exception
	    {
	        con=Mycon.getConnection();
		...
		public boolean updatecivilian() throws Exception
	    {
	        con=Mycon.getConnection();
