...
try 
{
	if(m.deletemessage())
{
		response.sendRedirect("retailer_home.jsp?msg=Your Message Has Been Deleted Successfully...");
}
else
{
	response.sendRedirect("retailer_home.jsp?msg=There Some Error Is Occured During Deletion of This Message....  ");
	}
}
catch(Exception e)
{
