        ...
        <div id="menu-wrapper">
          <div id="smoothmenu1" class="ddsmoothmenu">
            <ul>
              ...
              <li><a href="civilian_mail.jsp" class="selected">Mail Box</a></li>
...
%>         
                    ...
                    <tr>
                    <form action="civilianmessageshow.jsp" method="post" name="inbox">
        ...
        <div class="tab">
          <h3 style="color:Green;">Contact Farmers Retailers and WholeSaler</h3>
          <p>  
          <div align="left" style="background-color:#E0E0E0">   
                        
            <div id="Accordion1" class="Accordion" tabindex="0">
                 <div class="AccordionPanel">
                   <div class="AccordionPanelTab" style="height:30px"><strong><h4 style="color:Green;">Contact Farmers Retailers and WholeSaler</h4></strong></div>
                   <div class="AccordionPanelContent" style="height:400px">
            <p>&nbsp;</p>       
          <form name="contact_wholesaler" method="post" action="mail4.jsp" style="width: 516px; height: 319px">
...
%>                <form action="civilianrestoredeletemail.jsp" method="post" name="delete_messages">
                    <tr>
