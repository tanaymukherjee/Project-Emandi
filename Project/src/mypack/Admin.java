	...
	private String regno,name,emailid,renewpassword,newpassword,oldpassword,gender,dob,mobno,llno,address,state,city,pincode,newsletter,usertype,registrationno="null";
	 private Connection con;
	   ...
	   public Admin()
	   {
		...
		public Admin(String emailid,String name,String mobno,String llno,
		...
		public Admin(String llno, String address, String state, String city,
			String pincode) {
		...
		public Admin(String renewpassword,String newpassword, String oldpassword) {
