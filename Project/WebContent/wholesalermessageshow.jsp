      ...
      <div id="header">
        ...
        <div id="menu-wrapper">
          <div id="smoothmenu1" class="ddsmoothmenu">
            <ul>
              <li><a href="wholesaler_home.jsp" class="selected">Home</a></li>
...
%> 
  ...
  <div id="wrapper">
    ...
    <form action="deletewholesalermessage.jsp" method="post">
     <table border="1">
                    ...
                    <tr>
                        ...
                        <td height="50px"><%=a1.getMessage()%></td>
                        <tr><td><br></td></tr>
                    </tr>                         
                </table>
   ...
   <td colspan="2" align="left"><a href="wholesaler_mail.jsp"><font color="red">Back To Inbox &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp </font></a></td>
