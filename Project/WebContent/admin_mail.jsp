        ...
        <div id="menu-wrapper">
          <div id="smoothmenu1" class="ddsmoothmenu">
            <ul>
              ...
              <li><a href="admin_mail.jsp" class="selected">Mail Box</a></li>
...
%>         
                    ...
                    <tr>
                    <form action="adminmessageshow.jsp" method="post" name="inbox">
        ...
        <div class="tab">
          <h3 style="color:Green;">Contact Farmers-Wholesaler-Retailer</h3>
          <p>  
          <div align="left" style="background-color:#E0E0E0">   
                        
            <div id="Accordion1" class="Accordion" tabindex="0">
                 <div class="AccordionPanel">
                   <div class="AccordionPanelTab" style="height:30px"><strong><h4>Contact Farmers-Wholesaler-Retailer</h4></strong></div>
                   <div class="AccordionPanelContent" style="height:400px">
            <p>&nbsp;</p>       
          <form name="contact_farmer" method="post" action="mail3.jsp" style="width: 516px; height: 319px">
...
%>                <form action="adminrestoredeletemail.jsp" method="post" name="delete_messages">
                    <tr>
                        ...
                        <td><INPUT type=text name="date" readonly="readonly" style="background:none;border:0;color:" VALUE="<%=a3.getDdate()%>"  size="11px"> </td>
...
%>                 
                    ...
                    <form action="" method="post" name="inbox">
                        ...
                        <td><INPUT type=text name="status" readonly="readonly" style="background:none;border:0;color:" VALUE="<%=a2.getUsertype()%>" size="10px"></td>
                        <td><input type="submit" name="subject" value="<%=a2.getSubject()%>" style="background:none;border:0;color:#ff0000"  size="15px"/></td>
                        <td><INPUT type=text name="date" readonly="readonly" style="background:none;border:0;color:" VALUE="<%=a2.getDdate()%>" size="15px"></td>
                   </form>
                    </tr>
       <%
}
