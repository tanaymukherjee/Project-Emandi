...
<div id="container">
  ...
  <div id="page-top">
    <div id="header-wrapper">
      <!-- Begin Header -->
      <div id="header">
        <div id="logo"><a href="farmer_home.jsp"></a></div>
        <!-- Logo -->
        <!-- Begin Menu -->
        <div id="menu-wrapper">
          <div id="smoothmenu1" class="ddsmoothmenu">
            <ul>
              ...
              <li><a href="farmer_features.jsp" class="selected">Features</a></li>
...
<tr>
                    <form action="farmerrrequirementcontact.jsp" method="post" name="inbox">
   ...
   <%}%>                   
      ...
      <div class="tab">
          ...
          <div align="center" style="background-color:#E0E0E0">
          <p>&nbsp;</p>
             <form name="post_availability" method="post" action="postavailability.jsp" style="width: 516px; height: 319px">
  ...
  <tr>
     ...
     <td></td>
      ...
      <div class="tab">
          ...
          <div align="center" style="background-color:#E0E0E0">
          <p>&nbsp;</p>
             <form name="feedback" method="post" action="farmercomplaint.jsp" style="width: 516px; height: 319px">
