...
c11.setPrice(request.getParameter("price"));
ResultSet rs1=c11.getcommoditycontact();
...
if(rs1.next())
{
       ...
       c11 = new Commodity(rs1.getString(1),rs1.getString(2),rs1.getString(3),rs1.getString(8));        
