        ...
        <div id="menu-wrapper">
          <div id="smoothmenu1" class="ddsmoothmenu">
            <ul>
              ...
              <li><a href="wholesaler_edit.jsp" class="selected">Edit</a></li>
   ...
   <!-- whose profile indicator-->
    ...
    <li>Edit Profile</li>
      ...
      <div class="tab-content">
        ...
        <p>&nbsp;</p>
        <form name="wholesaler_change_pass" method="post" action="wholesalerchangepassword.jsp" style="width: 516px; height: 319px">
...
ResultSet rs=a1.getwholesalerprofile();

if(rs.next())
{
       
       a1 = new WholeSaler(emailid,rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8),rs.getString(9),rs.getString(10),rs.getString(11));        
...
%>       
        ...
        <div class="tab">
          ...
          <div align="center" style="background-color:#E0E0E0">
          <p></p> 
          <form name="form1" action="updatewholesalerprofile.jsp" method="post" style="width: 516px; height: 319px">
...
<form action="wholesalerupdateavailability.jsp" method="post" name="myform" onsubmit="return onsubmitform();">
   <tr>
