  ...
  <div id="wrapper">
    ...
    <div class="content">
      <h2 style="color:Green;">Message</h2>
          <form action="deleteretailermessage.jsp" method="post">
     <table border="1">
   ...
   <td colspan="2" align="left"><a href="retailer_mail.jsp"><font color="red">Back To Inbox &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp </font></a></td>
