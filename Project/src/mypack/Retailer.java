	...
	private String regno,name,emailid,renewpassword,newpassword,oldpassword,gender,dob,mobno,llno,address,state,city,pincode,newsletter,usertype,registrationno="null";
	 private Connection con;
	   ...
	   public Retailer()
	   {
	    ...
	    public Retailer(String emailid) {
		...
		public Retailer(String emailid,String name,String mobno,String llno,
		...
		public Retailer(String llno, String address, String state, String city,
			String pincode) {
		...
		public Retailer(String renewpassword,String newpassword, String oldpassword) {
		...
		public ResultSet getretailerprofile() throws Exception
	    {
	        con=Mycon.getConnection();
		...
		public boolean updateretailerprofile() throws Exception
	    {
	        con=Mycon.getConnection();
