...
{
		response.sendRedirect("wholesaler_home.jsp?msg=Your Message Has Been Restored Successfully...");
}
else
{
	response.sendRedirect("wholesaler_home.jsp?msg=There Some Error Is Occured During Restore of This Message....  ");
	}
}
catch(Exception e)
{
