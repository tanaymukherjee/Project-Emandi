        ...
        <div id="menu-wrapper">
          <div id="smoothmenu1" class="ddsmoothmenu">
            <ul>
              ...
              <li><a href="admin_edit.jsp" class="selected">Edit</a></li>
  ...
  <!-- whose profile indicator-->
    ...
    <li>Edit Profile</li>
      ...
      <div class="tab-content">
        ...
        <p>&nbsp;</p>
        <form name="admin_change_pass" method="post" action="adminchangepassword.jsp" style="width: 516px; height: 319px">
...
if(rs.next())
{
       ...
       a1 = new Admin(emailid,rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8),rs.getString(9),rs.getString(10));        
...
%>     
        ...
        <div class="tab">
          ...
          <p></p> 
          <form name="form1" action="updateadminprofile.jsp" method="post" style="width: 516px; height: 319px">
