        ...
        <div id="menu-wrapper">
          <div id="smoothmenu1" class="ddsmoothmenu">
            <ul>
              ...
              <li><a href="farmer_edit.jsp" >Edit</a></li>
              <li><a href="farmer_mail.jsp" class="selected">Mail Box</a></li>
...
%>         
                    ...
                    <tr>
                    <form action="farmermessageshow.jsp" method="post" name="inbox">
                        ...
                        %>
                        <td><INPUT type=text name="date" readonly="readonly" style="background:none;border:0;color:" VALUE="<%=a1.getDdate()%>" size="10px"></td>
                    </form> 
                    </tr>
        ...
        <div class="tab">
          <h3 style="color:Green;">Contact Wholesaler and Retailers</h3>
          <p>  
          <div align="left" style="background-color:#E0E0E0">   
                        
            <div id="Accordion1" class="Accordion" tabindex="0">
                 <div class="AccordionPanel">
                   <div class="AccordionPanelTab" style="height:30px"><strong><h4 style="color:Red;">Contact Wholesaler And Retailer</h4></strong></div>
                   <div class="AccordionPanelContent" style="height:400px">
            <p>&nbsp;</p>       
          <form name="contact_wholesaler" method="post" action="mail.jsp" style="width: 516px; height: 319px">
...
%>                <form action="farmerrestoredeletemail.jsp" method="post" name="delete_messages">
                    <tr>
