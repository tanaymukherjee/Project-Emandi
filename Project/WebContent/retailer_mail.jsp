        ...
        <div id="menu-wrapper">
          <div id="smoothmenu1" class="ddsmoothmenu">
            <ul>
              ...
              <li><a href="retailer_mail.jsp" class="selected">Mail Box</a></li>
...
<tr>
                    <form action="retailermessageshow.jsp" method="post" name="inbox">
                        ...
                        <td><INPUT type=text name="status" readonly="readonly" style="background:none;border:0;color:" VALUE="<%=a1.getUsertype()%>" size="11px"></td>
        ...
        <div class="tab">
          <h3 style="color:Green;">Contact Farmers,Wholesaler And Retailer</h3>
          <p>  
          <div align="left" style="background-color:#E0E0E0">   
                        
            <div id="Accordion1" class="Accordion" tabindex="0">
                 <div class="AccordionPanel">
                   <div class="AccordionPanelTab" style="height:30px"><strong><h4>Contact Farmers,Wholesaler And Retailer</h4></strong></div>
                   <div class="AccordionPanelContent" style="height:400px">
            <p>&nbsp;</p>       
          <form name="contact_farmer" method="post" action="mail2.jsp" style="width: 516px; height: 319px">
...
%>         <form action="retailerrestoredeletemail.jsp" method="post" name="delete_messages">
					 <tr>
